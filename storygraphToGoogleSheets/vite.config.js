...
const userscriptName = 'storygraphToGoogleSheets';
  ...
  plugins: [
    monkey({
      ...
      userscript: {
        ...
        updateURL: `https://raw.githubusercontent.com/laurinsorgend/userscripts/main/storygraphToGoogleSheets/dist/${userscriptName}.meta.js`,
        downloadURL: `https://raw.githubusercontent.com/laurinsorgend/userscripts/main/storygraphToGoogleSheets/dist/${userscriptName}.user.js`,
